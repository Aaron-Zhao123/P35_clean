...
HD_PWD='/auto/homes/yaz21/P35_clean/v3/rtl/ip_repo/edit_nn0_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nn0_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nn0_v1_0.tcl -notrace
