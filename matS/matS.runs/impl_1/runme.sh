...
HD_PWD='/auto/homes/hc475/P35/rtl/matS/matS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mat_mul_TB.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mat_mul_TB.tcl -notrace
