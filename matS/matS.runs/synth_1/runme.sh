...
HD_PWD='/auto/homes/hc475/P35/rtl/matS/matS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mat_mul_TB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mat_mul_TB.tcl
